...
## x: predictor
## y: response variable
## n_values: number of threshold values to try - higher = more precision
## quantile: determines where the windows of tried values starts and stops;
## by default we use the 80% of central values, leaving 10% of smallest and 
## largest values
...
```{r}
test_data <- core_data   # Enter all_predictor_data or core_data
...
cor_matrix <- cor(random_forest_data %>% select(-c(iso_code, year, income_group)))
cor_matrix
